...
#include "../twimanager/twimanager.h"
#include "../sensor.h"
...
class EMC1701 : public utility::FreeRTOSTask {
public:
...
namespace emc1701 {
	namespace sensor {
		class EMCSensor {
		public:
			void init(EMC1701 *const parent);
		protected:
			EMC1701 *parent = nullptr;
		};

		class Current : public Sensor<float>, public EMCSensor {
		public:
			float voltageDifference();
			float value() override;
		};

		class Voltage : public Sensor<float>, public EMCSensor {
		public:
			float value() override;
		};
	}
