...
//Configurations used in constructors of servos

constexpr timer::StaticConfig<float>::Result res0 = timer::StaticConfig<float>::calculateResult(
...
constexpr timer::StaticConfig<float>::Result res1 = timer::StaticConfig<float>::calculateResult(
